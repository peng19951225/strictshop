  ...
  <div>
    ...
    <div class="register-wrapper">
      <div id="register">
        ...
        <p style="font-size:16px;color:gray;margin:30px 0;">很高兴您将成为商城新的会员（注册只需一步，1刀999）</p>
        <el-form
          :model="ruleForm2"
          status-icon
          :rules="rules2"
...
export default {
  ...
  data() {
    ...
    let imgcode = (rule, value, callback) => {
      if (value === "") {
  ...
  methods: {
    ...
    sendCode() {
      ...
      if (this.checkMobile(tel)) {
        ...
        //  console.log(_product.imgcodeUrl(this.ruleForm2))
        _product.photocodeUrl(this.ruleForm2).then(res=>{
            console.log(res)
        });
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          console.log(_product.WCphotocodeUrl(this.ruleForm2))
